  ...
  return (
    <div className="custom-container flex flex-col gap-8 py-12">
      <div className="flex flex-col gap-4">
        ...
        <p className="text-neutral-500">{Tc.tAndC.pera[0]}</p>
        <p className="text-neutral-500">{Tc.tAndC.pera[1]}</p>
      </div>
      ...
      <div className="flex flex-col gap-4">
        <h1 className="text-xl sm:text-3xl font-semibold">{Tc.usLc.heading}</h1>
      ...
      <div className="flex flex-col gap-4">
        ...
        {Tc.sAndW.list.map((obj, id) => (
          <div key={id} className="flex flex-col gap-4">
            <h1 className="text-lg sm:text-2xl text-blue-800">{obj.heading}</h1>
