...
export default function CardsContainer() {
  return (
    <div className="custom-container py-12">
      <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-12 md:gap-12 xl:gap-6">
        {contactUsData.map((obj, index) => (
          <div
            key={obj.heading}
            className={`flex flex-col items-center rounded-2xl border border-slate-100 hover:shadow-[5px_5px_10px_black] transition ${index==2 ? 'md:col-span-2 xl:col-span-1':''}`}
          >
