...
export default function TechStack() {
  ...
  return (
    <div className="custom-container flex flex-col gap-6 pt-12 ourTechStack">
      <h1 className="text-4xl text-center font-bold relative">
        Our Tech Stack
      </h1>
      <p className="w-full md:w-3/4 text-center mx-auto relative">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 lg:gap-8 w-full md:w-4/5 mx-auto relative">
        {imgArray.map((obj, id) => (
          <div
            key={id}
            className="bg-slate-50 flex items-center justify-center py-2 border px-2 relative"
          >
            <Image
              key={id}
              src={obj.src}
