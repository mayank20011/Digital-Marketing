...
export default function LetsTalkAboutProject(){
  return (
    <div className="flex flex-col gap-6 md:gap-12 custom-container text-center pt-12">
      <h1 className="text-2xl lg:text-4xl xl:text-6xl font-bold">LET&apose;S TALK ABOUT PROJECT</h1>
      <p>Let&apos;s bring it to life together. Whether you&apose;re starting from scratch or need expert help scaling your existing product, we&apos;re here to understand your goals and turn them into a powerful digital solution—designed for impact, growth, and real results.</p>
