      ...
      <div className="custom-container flex-col flex gap-6 md:gap-12">
        ...
        <div className="flex flex-col gap-6 md:flex-row md:gap-12 items-center">
          <div className="w-full md:w-1/2 lg:w-4/10 relative">
            <div className="absolute w-full h-full border-[5px] rounded-4xl border-orange-300 mt-[22px] ml-[22px] -z-1"></div>
            <Image src={FounderMessageData.src} alt={FounderMessageData.alt} width={500} height={500} className="w-full border-2  rounded-4xl transition duration-700 shadow-[10px_10px_1px_black] brightness-70"/>
          </div>
