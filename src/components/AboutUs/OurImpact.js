  ...
  return (
    <>
      <div className="custom-container roundex-full border border-slate-100 p-6 lg:px-24 lg:py-6 rounded-2xl flex gap-6 flex-col items-center  bg-gradient-to-tr from-orange-100 to-blue-100 shadow-black">
        <h1 className="text-2xl md:text-3xl lg:text-5xl font-bold text-transparent bg-gradient-to-tr from-orange-400 to-pink-400 bg-clip-text drop-shadow-[1px_1px_1px_black]">
          Our Impact Numbers
        </h1>
        <div className="grid grid-cols-2 lg:grid-cols-4 w-full gap-6 md:gap-6 items-center">
          {OurImpactData.cards.map((obj, index) => (
            <div
              key={obj.number}
              className="flex justify-start md:justify-center parentCountDiv"
            >
              <div className={`flex flex-col gap-2 w-fit`}>
                ...
                <div className="flex gap-2 items-center text-center">
                  <h1 className="text-3xl md:text-4xl 2xl:text-5xl font-bold text-white bg-clip-text drop-shadow-[1px_1px_1px_black] numberCount" data-val={obj.number}>
                    00
                  </h1>
                ...
                <h5 className="text-neutral-500 drop-shadow-[1px_1px_1px_white]">
                  {obj.heading}
                </h5>
              </div>
            </div>
