    ...
    <>
      <div className="custom-container gap-6 flex items-center flex-col md:flex-row">
        <div className="order-2 md:order-1 md:w-1/2 flex flex-col gap-4 2xl:gap-6 w-full  overflow-y-hidden ">
          <h1 className="max-w-full whitespace-normal break-words text-2xl sm:text-3xl xl:text-5xl font-bold">
          ...
          <Link
            href={"/contact-us"}
            className="block bg-black w-fit px-4 py-2 text-sm text-white hover:bg-white hover:text-black  hover:border-black border-2 border-black transition rounded-md hover:scale-90"
          >
            Contact Us
          </Link>
        </div>
