      ...
      <div className="custom-container flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {cards.map((card, id) => (
            <div
              key={id}
              className={`flex flex-col gap-4 p-6 rounded-5xl rounded-4xl shadow-2xl rounded-tr-none rounded-bl-none border border-slate-100 bg-slate-50 hover:scale-102 transition hover:-translate-y-[10px]`}
            >
