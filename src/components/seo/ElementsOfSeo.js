  ...
  return (
    <div className="">
      <div className="custom-container flex flex-col gap-6 text-center">
        ...
        <p className="text-md lg:text-lg text-neutral-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cards.map((card, id) => (
            <div
              className="bg-gradient-to-t from-orange-300 to-pink-300 p-[2px] rounded-lg transition duration-300 flex hover:scale-102 hover:-translate-y-[5px] "
              key={id}
            >
