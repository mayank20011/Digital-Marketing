  ...
  return (
    <div>
      <div className="custom-container flex flex-col gap-6">
        <div className="flex gap-6 md:gap-12 lg:gap-24 flex-col md:flex-row items-center GrowYourBusinesswithSmartSeo">
          <div className="w-full md:w-1/2 flex flex-col gap-6 growYourBusinessText">
            ...
            <div className="grid grid-cols-2 gap-4">
              {bp.map((points,id)=>(
                <div key={id} className=" relative flex gap-3 items-center bulletPoints">
          ...
          <div className="w-full md:w-1/2  rounded-4xl border-2 border-orange-600 growBusinessImg">
        ...
        <div className="bg-gradient-to-r from-orange-600 to-pink-600 p-[2px] rounded-[50px] lg:w-4/5 relative growBusinessimgesDiv">
