  ...
  return (
    <div className="w-full relative py-8 md:py-24 lg:py-36">
      <div className="custom-container flex flex-col gap-6 text-center">
        ...
        <Link
          href={"/contact-us"}
          className="w-fit bg-gradient-to-tr from-orange-300 to-pink-300 mx-auto border px-4 py-2 rounded-full hover:-translate-y-[10px] transition shadow-[3px_3px_1px_black]"
        >
          Lets Scale Together
        </Link>
      </div>
