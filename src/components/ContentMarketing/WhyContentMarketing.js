...
export default function WhyContentMarketing() {
  return (
    <div>
      <div className="custom-container text-center flex flex-col gap-6 md:gap-12 qualityContent">
        <h1
        ...
        <p className="text-md md:text-lg relative">
        ...
        <Link
          href={"/contact-us"}
          className="border w-fit mx-auto px-4 py-2 rounded-xl hover:-translate-y-[5px] hover:shadow-[5px_5px_1px_black] transition hover:bg-gradient-to-t  from-orange-400 to-pink-400 hover:text-white font-bold text-sm md:text-md relative"
        >
          Lets Connect
        </Link>
      </div>
