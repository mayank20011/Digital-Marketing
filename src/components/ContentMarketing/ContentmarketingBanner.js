  ...
  return (
    <div>
      <div className="custom-container flex gap-6 items-center flex-col md:flex-row">
        <div className="w-full md:w-1/2 flex flex-col gap-6 order-2 md:order-1 heroTextDiv opacity-0">
          <h1
            style={{ filter: "drop-shadow(1px 1px 1px black)" }}
            className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-white relative"
          >
          ...
          <Link
            href={"/contact-us"}
            className="text-white text-center rounded-full border border-slate-200 hover:shadow-[5px_5px_2px_black] transition py-2 hover:-translate-y-[5px] bg-gradient-to-r from-orange-400 to-pink-600 w-fit px-4 relative"
        ...
        <Image
          ...
          width={800}
          height={800}
          className="w-full md:w-1/2 order-1 md:order-2 heroImg opacity-0 relative"
